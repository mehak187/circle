...
const Header = () => (
  <section className="main vh-100">
    <div className="container">
      <div className="row justify-content-center justify-content-md-start vh-100 py-5">
        <div className="col-sm-8 col-md-6 col-lg-4 d-flex align-items-center  flex-column my-5">
          <img src={logo} className="w-100 px-5 px-lg-0" alt="Example" />
